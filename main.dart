...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Header'),backgroundColor: theme.colorScheme.primary, ),
      body: Center(
        child: Column(
...
var style = theme.textTheme.displayMedium!.copyWith(color: theme.colorScheme.onPrimary);
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Text(wordPair.asPascalCase, style: style, semanticsLabel: wordPair.asPascalCase, ),
      ),
    );
  }
}